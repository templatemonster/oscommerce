...
<h1 class="page-heading product-list"><?php echo HEADING_TITLE_2; ?></h1>
...
?>
  <div class="buttonSet button-container"> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false)); ?> </div>
</div>
<?php
