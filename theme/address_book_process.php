...
// needs to be included earlier to set the success message in the messageStack
  ...
  $current_page = FILENAME_ADDRESS_BOOK_PROCESS;
...
<?php
  if (isset($HTTP_GET_VARS['delete'])) {
?>
<div class="block-content account book-edit-delete">
  <h2 class="page-subheading"><?php echo DELETE_ADDRESS_TITLE; ?></h2>
  <div class="contentText">
    <p><?php echo DELETE_ADDRESS_DESCRIPTION; ?></p>
    <div class="box"><?php echo tep_address_label($customer_id, $HTTP_GET_VARS['delete'], true, ' ', '<br />'); ?></div>
  </div>
  <div class="button-container clearfix"> <span class="pull-right"> <?php echo tep_draw_button(IMAGE_BUTTON_DELETE, 'trash btn btn-default', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $HTTP_GET_VARS['delete'] . '&action=deleteconfirm&formid=' . md5($sessiontoken), 'SSL'), 'primary'); ?> </span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w btn btn-default', tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL')); ?> </div>
</div>
<?php
  } else {
?>
...
<div class="block-content account book-edit">
  <div class="box">
  ...
  <?php
        if (isset($HTTP_GET_VARS['edit']) && is_numeric($HTTP_GET_VARS['edit'])) {
    ?>
  <div class="buttonSet button-container clearfix"> <span class="pull-right"><?php echo tep_draw_hidden_field('action', 'update') . tep_draw_hidden_field('edit', $HTTP_GET_VARS['edit']) . tep_draw_button(IMAGE_BUTTON_UPDATE, 'refresh btn btn-default', null, 'primary'); ?></span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL')); ?> </div>
  <?php } else {
  ...
  <div class="buttonSet"> <span class="pull-right"><?php echo tep_draw_hidden_field('action', 'process') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w btn btn-default', $back_link); ?> </div>
  <?php
        }
    ?>
</div>
