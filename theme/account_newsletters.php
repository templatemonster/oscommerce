...
<div class="block-content">
  <div class="box">
    <h2 class="page-subheading"><?php echo MY_NEWSLETTERS_TITLE; ?></h2>
    <div class="checkbox">
      <label><?php echo tep_draw_checkbox_field('newsletter_general', '1', (($newsletter['customers_newsletter'] == '1') ? true : false)); ?><strong><?php echo MY_NEWSLETTERS_GENERAL_NEWSLETTER; ?></strong></label>
    </div>
    <p><?php echo MY_NEWSLETTERS_GENERAL_NEWSLETTER_DESCRIPTION; ?></p>
  </div>
  <div class="buttonSet button-container clearfix"> <span class="pull-right"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_ACCOUNT, '', 'SSL')); ?> </div>
</div>
</form>
<?php
