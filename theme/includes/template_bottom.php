...
<div id="columnRight" class="col-xs-<?php echo $oscTemplate->getGridColumnWidth(); ?>"> <?php echo $oscTemplate->getBlocks('boxes_column_right'); ?> </div>
<?php }?>
</div>
<!-- row -->
</div>
...
<?php if(LIVE_CHAT && LIVE_CHAT =='true') { ?>
<!-- begin olark code --> 
