...
*/
  ...
  class sb_twitter {
    ...
    function getOutput() {
      ...
      return '<a title="twitter" href="http://twitter.com/home?status=' . urlencode(tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL', false)) . '" target="_blank"><i class="fa fa-twitter"></i></a>';
    }
