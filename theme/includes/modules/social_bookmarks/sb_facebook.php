...
*/
  ...
  class sb_facebook {
    ...
    function getOutput() {
      ...
      return '<a title="Facebook" href="http://www.facebook.com/share.php?u=' . urlencode(tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL', false)) . '" target="_blank"><i class="fa fa-facebook"></i></a>';
    }
