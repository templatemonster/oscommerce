		...
		function execute()
		{
			...
			if (!isset($HTTP_GET_VARS['products_id'])) {
				...
				if (tep_db_num_rows($best_sellers_query) >= MIN_DISPLAY_BESTSELLERS) {
					$bestsellers_list = '<ul class="box-list">';
					...
					$data = '<div class="module bestsellers-box">' . '  <h3 class="module-heading"><a href="' . tep_href_link(FILENAME_TOPSELLERS_PRODUCTS) . '">' . MODULE_BOXES_BEST_SELLERS_BOX_TITLE . '</a></h3>' . '  <div class="module-content">' . $bestsellers_list . '</div>' . '</div>';
