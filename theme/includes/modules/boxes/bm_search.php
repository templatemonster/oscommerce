<?php
  ...
  class bm_search {
    ...
    function execute() {
      ...
      $data = '<div class="module search-box">' .
              '  <h3 class="module-heading">' . MODULE_BOXES_SEARCH_BOX_TITLE . '</h3>' .
              ...
              '    </form>' .
              '  </div><p>'. MODULE_BOXES_SEARCH_BOX_TEXT . '</p><a class="btn-link" href="' . tep_href_link(FILENAME_ADVANCED_SEARCH) . '">' . MODULE_BOXES_SEARCH_BOX_ADVANCED_SEARCH . '</a></div>' .
              '</div>';
