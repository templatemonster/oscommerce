...
define('TEXT_DISPLAY_NUMBER_OF_TOPSELLERS', 'angezeigte Angebote <b>%d</b> bis <b>%d</b> (von <b>%d</b> top-tseller)');
...
define('IMAGE_BUTTON_RP_BUY_NOW', 'Kaufen');
/***********************************/

// BOF: Featured Products
define('TABLE_HEADING_FEATURED_PRODUCTS', 'Ausgewählte Artikel');
define('TABLE_HEADING_FEATURED_PRODUCTS_CATEGORY', 'Ausgewählte Artikel in %s');
// EOF: Featured Products

// BOF: Featured Products
define('BOX_CATALOG_FEATURED_PRODUCTS', 'Ausgewählte Artikel');
// featured box text in includes/boxes/featured.php
define('BOX_HEADING_FEATURED', 'Besondere');
// EOF: Featured Products
