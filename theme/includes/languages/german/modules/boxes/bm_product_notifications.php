...
*/
  ...
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_BOX_NOTIFY', 'Eine Nachricht bei &Auml;nderungen zu <strong>%s</strong> versenden.');
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_BOX_NOTIFY_REMOVE', 'Keine Nachricht bei &Auml;nderungen zu <strong>%s</strong> versenden.');
?>
