...
define('TEXT_ORIGIN_LOGIN', '<small class="red"><strong>NOTE:</strong></small> If you already have an account with us, please login at the <a href="%s"><u>login page</u></a>.');
