...
define('TEXT_NO_HTML', '<small><span class="required">NOTE:</span>HTML is not translated!</small>');
define('TEXT_BAD', '<small><span class="required">BAD</span></small>');
define('TEXT_GOOD', '<small><span class="required">GOOD</span></small>');
