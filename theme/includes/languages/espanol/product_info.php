...
define('TEXT_RELATED_PRODUCTS', 'Otros productos que te gustarían');
define('RELATED_PRODUCTS_MODEL_COMBO', ' (%s)');
define('RELATED_PRODUCTS_PRICE_TEXT', '%s');
define('RELATED_PRODUCTS_QUANTITY_TEXT', 'Sólo el %s izquierda!');
/***********************************/
/* Tags */
define('TAGS_PRODUCT', 'Etiquetas del producto');
