...
<div class="block-content">
  <div class="box">
    ...
    <div class="row">
      <div class="col-xs-3"><?php echo ENTRY_EMAIL_ADDRESS; ?></div>
      <div class="col-xs-9"><?php echo tep_draw_input_field('email_address'); ?></div>
    </div>
  </div>
  <div class="buttonSet button-container"> <span class="pull-right"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_LOGIN, '', 'SSL')); ?> </div>
</div>
</form>
<?php
  }
