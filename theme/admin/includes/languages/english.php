...
// Tags add (custom)
define('BOX_CATALOG_TAGS', '<strong>Tags</strong>');
...
define('BOX_CATALOG_CATEGORIES_RELATED_PRODUCTS', '<strong>Related Products</strong>');
...
define('BOX_CATALOG_FEATURED_PRODUCTS', '<strong>Featured Products</strong>');
...
// Superfish categories box
  define( 'TEXT_CACHE_CATEGORIES_SUPERFISH', 'Categories Superfish Box' );
