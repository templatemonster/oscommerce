...
<span class="pageHeading"><?php echo HEADING_TITLE_ATRIB; ?></span>
...
?>
            ...
            <td><a href="<?php echo tep_href_link(FILENAME_CONFIGURATION, 'selected_box=configuration&gID=' . $gID); ?>">Configuration Options</a><br>
...
?>
    <form name="attributes" action="<?php echo tep_href_link(FILENAME_RELATED_PRODUCTS, $form_params); ?>" method="get"><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
