...
<div class="block-content checkout-address">
  <?php
  if ($process == false) {
?>
  <div class="box">
...
?>
  <div class="box">
    <h2 class="page-subheading"><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></h2>
...
?>
  ...
  <div class="buttonSet button-container clearfix"><span class="pull-right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span></div>
</div>
<script type="text/javascript">
...
<?php
  if ($process == true) {
?>
<div class="buttonSet button-container clearfix"><span class="pull-right"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL')); ?></span></div>
<?php
  }
?>
</form>
