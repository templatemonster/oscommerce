...
<div class="box"> <?php echo $page_content; ?> </div>
<div class="buttonSet button-container clearfix"> <span class="pull-right"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-success', null, 'primary'); ?></span> </div>
</form>
<?php
