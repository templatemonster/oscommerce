...
<h1 class="page-heading product-list"><?php echo $category['categories_name']; ?></h1>
...
// check to see if there are deeper categories within the current category
    ...
    while ($categories = tep_db_fetch_array($categories_query)) {
      ...
      $num = (int)(12 / MAX_DISPLAY_CATEGORIES_PER_ROW);
      echo  '	<li class="col-xs-'.$num.'">'.
	  		'		<div class="product-image-box">'.
			'			<a class="product-image" href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '">' . tep_image(DIR_WS_IMAGES . $categories['categories_image'], $categories['categories_name'], SUBCATEGORY_IMAGE_WIDTH, SUBCATEGORY_IMAGE_HEIGHT).'</a>'.
			'		</div>'.
			'		<a class="product-name" href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '">' . $categories['categories_name'] .'</a>'.
			'	</li>';
    }
...
?>
<h1 class="page-heading product-list"><?php echo $catname; ?></h1>
...
// optional Product List Filter
    if (PRODUCT_LIST_FILTER > 0) {
      ...
      if (tep_db_num_rows($filterlist_query) > 1) {
        echo '' . tep_draw_form('filter', tep_href_link( FILENAME_DEFAULT ), 'get', '', false,' filter');
        if (isset($HTTP_GET_VARS['manufacturers_id']) && !empty($HTTP_GET_VARS['manufacturers_id'])) {
...
<?php
  ...
  require(DIR_WS_INCLUDES . 'template_top.php');
      ...
      if (($oscTemplate->hasBlocks('boxes_home_content')))	{
     		echo $oscTemplate->getBlocks('boxes_home_content');
      }
...
?>
<div class="contentText"> <?php echo TEXT_MAIN; ?> </div>
<?php
    }

    include(DIR_WS_MODULES . FILENAME_NEW_PRODUCTS);
	if (FEATURED_PRODUCTS_DISPLAY_HOME == 'true') {
