...
// needs to be included earlier to set the success message in the messageStack
  ...
  $current_page = FILENAME_CHECKOUT_PAYMENT_ADDRESS;
...
<div class="block-content checkout-payment-address">
  <?php
  if ($process == false) {
?>
  <div class="box">
    <h2 class="page-subheading"><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></h2>
    <div class="bottom-indent"> <?php echo tep_address_label($customer_id, $billto, true, ' ', '<br />'); ?> </div>
    <?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?> </div>
  <?php
    if ($addresses_count > 1) {
?>
  <div class="box">
    <h2 class="page-subheading"><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h2>
...
?>
        ...
        <td><strong><?php echo $addresses['firstname'] . ' ' . $addresses['lastname']; ?></strong>
          <p><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?></p></td>
        <td class="text-right align-middle"><?php echo tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $billto)); ?></td>
      </tr>
      <?php
        $radio_buttons++;
      }
...
?>
  <div class="box">
    <h2 class="page-subheading"><?php echo TABLE_HEADING_NEW_PAYMENT_ADDRESS; ?></h2>
...
?>
  ...
  <div class="buttonSet button-container"><span class="pull-right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span></div>
  <script type="text/javascript">
$('#coProgressBar').progressbar({
  ...
  if ($process == true) {
?>
  <div class="buttonSet button-container"><span class="pull-right"> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL')); ?> </span></div>
  <?php
  }
?>
</div>
