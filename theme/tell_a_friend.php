...
<h1 class="page-heading"><?php echo sprintf(HEADING_TITLE, $product_info['products_name']); ?></h1>
<?php
...
<div class="block-content send-a-friend">
  <div class="box">
    <p class="require text-right"><?php echo FORM_REQUIRED_INFORMATION; ?></p>
    <h2 class="page-subheading"><?php echo FORM_TITLE_CUSTOMER_DETAILS; ?></h2>
    <div class="form-group">
      <label><?php echo FORM_FIELD_CUSTOMER_NAME; ?></label>
      <?php echo tep_draw_input_field('from_name'); ?> </div>
    <div class="form-group">
      <label><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></label>
      <?php echo tep_draw_input_field('from_email_address'); ?> </div>
  </div>
  <div class="box">
    <h2 class="page-subheading"><?php echo FORM_TITLE_FRIEND_DETAILS; ?></h2>
    <div class="form-group">
      <label><?php echo '<sup class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</sup> ' . FORM_FIELD_FRIEND_NAME; ?></label>
      <?php echo tep_draw_input_field('to_name'); ?> </div>
    <div class="form-group">
      <label><?php echo '<sup class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</sup> '.FORM_FIELD_FRIEND_EMAIL; ?></label>
      <?php echo tep_draw_input_field('to_email_address') ?> </div>
  </div>
  <div class="box">
    <h2 class="page-subheading"><?php echo FORM_TITLE_FRIEND_MESSAGE; ?></h2>
    <?php echo tep_draw_textarea_field('message', 'soft', 40, 8); ?> </div>
  <div class="buttonSet button-container"> <span class="pull-right"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'btn btn-default', null, 'primary'); ?></span> <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'btn btn-default', tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$HTTP_GET_VARS['products_id'])); ?> </div>
</div>
</form>
<?php
